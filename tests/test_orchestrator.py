...
def mock_orchestratorconfig(tmpdir):
    ...
    user_config_file = orchestrator.CONFIG_FILE
    orchestrator.CONFIG_FILE = str(mock_config_file)

    yield mock_config_file

    # reset global variable
    orchestrator.CONFIG_FILE = user_config_file
...
def test__get_orchestrator_config(mock_orchestratorconfig):
    ...
    test_config = orchestrator._get_orchestrator_config()
...
def test__get_orchestrator_config_no_config_file(tmpdir):
    ...
    # point global variable to mock config
    user_config_file = orchestrator.CONFIG_FILE
    orchestrator.CONFIG_FILE = mock_config_file
...
def test__save_orchestrator_config(tmpdir):
    ...
    orchestrator._save_orchestrator_config({'foo': 'bar'})
...
def test_add_toolregistry(tmpdir):
    ...
    # workflow orchestrator app
    orchestrator.add_toolregistry('Dockstore')
...
def test_add_workflowservice(tmpdir):
    ...
    # workflow orchestrator app
    orchestrator.add_workflowservice('workflow-service')
